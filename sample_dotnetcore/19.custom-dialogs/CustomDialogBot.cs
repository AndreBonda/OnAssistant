...
namespace Microsoft.BotBuilderSamples
{
    ...
    public class CustomDialogBot : IBot
    {
        ...
        public CustomDialogBot(BotAccessors accessors)
        {
            ...
            var fullnameSlots = new List<SlotDetails>
            {
            ...
            var addressSlots = new List<SlotDetails>
            {
            ...
            _dialogs.Add(new SlotFillingDialog("address", addressSlots));
            _dialogs.Add(new SlotFillingDialog("fullname", fullnameSlots));
